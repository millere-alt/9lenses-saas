  ...
  return (
    <div className="relative">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        />
        <div
          className="absolute bottom-20 left-10 w-[600px] h-[600px] bg-gradient-to-tr from-blue-300/30 to-cyan-400/30 rounded-full blur-3xl"
      ...
      <div className="max-w-7xl mx-auto space-y-20">
        ...
        <div className="relative">
          {/* Progress Line */}
          <div className="hidden lg:block absolute top-24 left-0 right-0 h-1 bg-gradient-to-r from-blue-200 via-blue-300 via-blue-300 to-blue-200 rounded-full">
            <div
              className="h-full bg-gradient-to-r from-blue-500 via-blue-500 to-blue-500 rounded-full transition-all duration-1000"
        ...
        <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-3xl p-16 shadow-2xl">
          <h2 className="text-5xl font-black bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent mb-12 text-center">
            Detailed Process
          </h2>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div className="flex-grow">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-3xl font-black text-gray-800 group-hover:text-blue-600 transition-colors">
                          {step.title}
                        </h3>
                      </div>
