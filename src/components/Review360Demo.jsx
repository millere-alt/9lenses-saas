...
const Review360Demo = () => {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="relative overflow-hidden bg-gradient-to-br from-primary-600 via-secondary-600 to-blue-600 rounded-3xl p-8 text-white shadow-2xl">
        ...
        <div className="p-8">
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div className="mt-6 p-6 bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl border-l-4 border-primary-600">
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-4 gap-4">
                ...
                <div className="p-6 bg-blue-50 rounded-xl border-2 border-blue-200 text-center">
                  ...
                  <p className="text-4xl font-bold text-blue-700">{step.completionStats.completed}</p>
                </div>
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              ...
              <div className="p-6 bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl border-l-4 border-primary-600">
          ...
          {currentStep === 5 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-6xl font-bold bg-gradient-to-r from-primary-600 to-blue-600 bg-clip-text text-transparent">
                ...
                {step.scores.map((score, idx) => (
                  <div key={idx} className={`p-4 bg-${score.category === 'Assets' ? 'primary' : score.category === 'Processes' ? 'green' : 'secondary'}-50 rounded-lg border-2 border-${score.category === 'Assets' ? 'primary' : score.category === 'Processes' ? 'green' : 'secondary'}-200`}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`flex items-center gap-1 text-sm font-bold ${score.change >= 0 ? 'text-blue-600' : 'text-red-600'}`}>
              ...
              <div className="space-y-4">
                {step.insights.map((insight, idx) => (
                  <div key={idx} className={`p-6 rounded-xl border-2 ${
                    insight.type === 'Strength' ? 'bg-blue-50 border-blue-200' :
                    insight.type === 'Opportunity' ? 'bg-blue-50 border-blue-200' :
                    'bg-blue-50 border-blue-200'
                  }`}>
                    <div className="flex items-start gap-4">
                      <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                        insight.type === 'Strength' ? 'bg-blue-600' :
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                            insight.type === 'Strength' ? 'bg-blue-600 text-white' :
