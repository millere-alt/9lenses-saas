...
function AIStrategyAdvisor({ assessmentData, lensScores }) {
  ...
  const getPriorityColor = (priority) => {
    ...
    if (priority === 'High') return 'from-blue-500 to-blue-600';
    if (priority === 'Medium-High') return 'from-blue-400 to-blue-500';
    if (priority === 'Medium') return 'from-blue-400 to-blue-500';
        ...
        <div className="space-y-6 animate-slideUp">
          {isGenerating ? (
            <div className="bg-white rounded-2xl p-12 text-center shadow-lg">
              <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-secondary-600 rounded-full mx-auto mb-4 flex items-center justify-center animate-pulse">
