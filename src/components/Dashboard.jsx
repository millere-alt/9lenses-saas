...
function Dashboard() {
  ...
  const lensScores = [
    { name: 'Customers', score: 7.2, category: 'Assets', gradient: 'from-blue-400 to-blue-500', icon: Users, change: +5 },
    { name: 'Financials', score: 5.8, category: 'Assets', gradient: 'from-blue-500 to-blue-600', icon: TrendingUp, change: -2 },
    { name: 'Human Resources', score: 6.5, category: 'Assets', gradient: 'from-blue-400 to-blue-500', icon: Users, change: +3 },
    { name: 'Strategy', score: 7.0, category: 'Processes', gradient: 'from-cyan-400 to-blue-500', icon: Target, change: +4 },
    { name: 'Sales & Marketing', score: 6.2, category: 'Processes', gradient: 'from-blue-500 to-blue-500', icon: Zap, change: 0 },
  ...
  const stats = [
    ...
    },
    {
      ...
      subtitle: 'Financial',
      icon: AlertCircle,
      gradient: 'from-blue-400 via-blue-500 to-red-500',
  ...
  return (
    <div className="relative">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div
          className="absolute top-20 right-10 w-[500px] h-[500px] bg-gradient-to-br from-blue-300/20 to-blue-400/20 rounded-full blur-3xl"
      ...
      <div className="space-y-8">
        ...
        <div className="relative">
          <div className="flex items-center justify-between">
            <div>
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-50 to-blue-50 px-4 py-2 rounded-full border-2 border-blue-200 shadow-sm mb-4">
                <Sparkles size={16} className="text-blue-600" />
                <span className="text-xs font-bold bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent">
                  Live Assessment Results
                </span>
              </div>
              <h1 className="text-5xl font-black bg-gradient-to-r from-blue-600 via-blue-600 to-blue-600 bg-clip-text text-transparent mb-2">
                Results & Analytics
              </h1>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            {['Assets', 'Processes', 'Structures'].map((category, catIndex) => (
              <div key={catIndex} className="text-center">
                ...
                <div className="text-3xl font-black bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent">
                  {(lensScores
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-2 mt-1">
                          ...
                          <span className={`text-sm font-semibold ${
                            lens.change > 0 ? 'text-blue-600' : lens.change < 0 ? 'text-red-600' : 'text-gray-400'
                          }`}>
        ...
        <div>
          <h2 className="text-3xl font-black bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {insights.map((insight, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-blue-500/30 transition-all duration-500 hover:-translate-y-4"
                >
                  {/* Gradient Background */}
