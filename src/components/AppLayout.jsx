            ...
            <div className="flex items-center space-x-3">
              <button onClick={() => navigate('/')} className="flex items-center space-x-3">
                <div className="flex flex-col">
                  <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-600 via-blue-600 to-blue-600 bg-clip-text text-transparent">9Vectors</h1>
                ...
                {loading ? (
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="flex items-center space-x-2 px-4 py-2 rounded-xl bg-blue-50 hover:bg-blue-100 transition-colors border border-blue-200 shadow-sm hover:shadow-md"
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-neutral-600 font-medium">
              <span className="font-bold bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent">9Vectors</span> - Transform your business with strategic assessment and data-driven insights
            </p>
            <div className="flex items-center space-x-2 text-sm text-neutral-700 bg-blue-50 px-4 py-2 rounded-full">
