            ...
            <div className="flex items-center space-x-3">
              <button onClick={() => navigate('/')} className="flex items-center space-x-3 group">
                ...
                <div className="flex flex-col">
                  <h1 className="text-3xl font-semibold text-[#032d60]">9Lenses</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-600">
              <span className="font-semibold text-[#0176D3]">9Lenses</span> - Transform your business with strategic assessment and data-driven insights
            </p>
