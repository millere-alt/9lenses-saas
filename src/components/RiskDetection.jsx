...
function RiskDetection({ lensScores, assessmentData }) {
  ...
  const getSeverityColor = (severity) => {
    switch (severity) {
      ...
      case 'high': return { bg: 'from-blue-500 to-blue-600', text: 'text-blue-700', badge: 'bg-blue-100 text-blue-700 border-blue-300' };
      case 'medium': return { bg: 'from-blue-500 to-blue-600', text: 'text-blue-700', badge: 'bg-blue-100 text-blue-700 border-blue-300' };
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-br from-red-600 via-blue-600 to-blue-600 rounded-3xl p-8 text-white shadow-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border-2 border-blue-200">
          ...
          <p className="text-3xl font-bold text-blue-700">{riskSummary.riskScore}/100</p>
