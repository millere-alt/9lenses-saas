  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        {/* Quick Guide */}
        <div className="bg-gradient-to-r from-blue-50 to-primary-50 border-l-4 border-blue-500 rounded-lg p-4 max-w-4xl">
      ...
      <div className="flex justify-end gap-4 pt-6 border-t-2 border-neutral-200">
        <button
          ...
          className={`px-8 py-4 rounded-xl font-bold text-lg shadow-xl transition-all flex items-center gap-3 ${
            getSelectedCount() > 0
              ? 'bg-gradient-to-r from-primary-600 via-secondary-600 to-blue-600 text-white hover:shadow-2xl hover:scale-105'
