...
function AIDashboard() {
  ...
  const lensScores = [
    ...
    { name: 'Strategy', score: 7.0, category: 'Processes', gradient: 'from-blue-400 to-blue-500', change: 4 },
    { name: 'Sales & Marketing', score: 6.2, category: 'Processes', gradient: 'from-blue-500 to-blue-600', change: 0 },
    { name: 'Operations', score: 6.5, category: 'Processes', gradient: 'from-blue-400 to-blue-500', change: 1 },
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="relative overflow-hidden bg-gradient-to-br from-primary-600 via-blue-500 to-secondary-600 rounded-3xl p-8 text-white shadow-2xl">
