      ...
      <div className="grid grid-cols-3 gap-6 mb-8">
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="text-lg font-bold text-blue-900">Improving</h3>
          </div>
          <div className="text-3xl font-bold text-blue-700 mb-2">{improvingLenses.length}</div>
          <div className="text-sm text-blue-700">lenses showing improvement</div>
        </div>
            ...
            {improvingLenses.map((lens, idx) => (
              <div key={idx} className="border border-blue-200 bg-blue-50 rounded-lg p-4">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-2xl font-bold text-blue-700">+{lens.change}</span>
                  <span className="text-sm text-blue-600">({lens.percentChange}%)</span>
                </div>
